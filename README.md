...
　　ユーザーが部屋を作成し、他の参加者と一緒にどのボードゲームをプレイするか話し合うことができます。部屋内のチャット機能を活用して、日時やルールの調整を行い、スムーズにゲームを進められる環境を提供します。
  
### 開発の背景
新しいボードゲームを探している際、口コミや実際に経験した人の評価が見られないことが多く、本当に面白いゲームかどうかが判断しにくいと感じたことがありました。この課題を解決するため、ユーザーがボードゲームに関する情報を共有できる環境を作ることを目指しました。特に、遊んだ人の具体的なコメントや評価を閲覧できる仕組みにより、ユーザーが求めるボードゲームに出会えるようにしたいと考えました。
